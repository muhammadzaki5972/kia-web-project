...
async function loadData() {
    ...
    try {
        ...
        let rawDetail = normalizeData(data.detail || []);
...
function lihatDetail(id) {
    ...
    document.getElementById('detailModalTitle').innerText = pRow ? `${pRow[sheetHeadersPerkara.findIndex(h=>String(h || '').toLowerCase().includes('pemohon'))]} vs ${pRow[sheetHeadersPerkara.findIndex(h=>String(h || '').toLowerCase().includes('termohon'))]}` : 'Detail Perkara';
